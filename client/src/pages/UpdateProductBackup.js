                        ...
                        <div className="space-y-3">
                          ...
                          <div className="relative">
                            ...
                            <label
                              ...
                              className="flex items-center justify-center w-full p-6 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg cursor-pointer hover:border-orange-400 transition-colors bg-white/50 dark:bg-gray-700/50"
                            >
